...
function AboutMe(){
  return (
    <div className="row container">
      <Title />
      <hr />
      <p><span style={{marginLeft: '10px'}}>Thanks </span> for taking the time visit my portfolio. I am currently a student at Epicodus, a coding bootcamp in Portland Oregon. My education at Epicodus has given me great core programming fundamentals, and experience with cutting edge frameworks. I decided to attend Epicodus because of my passion for technology and interest in open-source development. I started by familiarizing myself with the command line and Git, while making web-pages using html and css. Later i learned Javascript, then Ruby along with Rails and postgreSQL. I have no doubt about my ability to learn any new technology the programming world has to offer.</p>
      <hr />
      <p>Before Web development, I worked as a customer service associate for QFC. I strove for excellence and customer satisfaction in my work as a cashier, making sure i resolve issues thoroughly and professionally. Also informing the customer of the product they are buying and pointing out any problems or caviates. While this experience may not be relevent to my programming skills, it does, however, attest to my core values as a human-being. The many years i spent doing this job shows that i work well with a diverse, fluid, constantly changing team.</p>
      <hr />
